...
if conn is not None:
    ...
    # create_product(conn, ("Apple", "fruits", 45, 20))
    # create_product(conn, ("Fanta", "drink", 89, 9))
    # create_product(conn, ("Banana", "fruits", 12.2, 50))
    # create_product(conn, ("Cake", "sweets", 54.8, 20))
    # create_product(conn, ("Orange", "fruits", 60.5, 20))
    # create_product(conn, ("Cake", "sweets", 60.5, 20))
    # create_product(conn, ("Orange", "fruits", 70.5, 20))
